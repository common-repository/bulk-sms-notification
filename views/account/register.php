...
echo'<!--Register with miniOrange-->
	<form name="f" method="post" action="">
		<input type="hidden" name="option" value="mobsms_register_customer" />
	 ...
	 <form name="f" method="post" action="" class="mobsms_verify_customerform">
        <input type="hidden" name="option" value="mobsms_goto_verifycustomer">
         <input type="hidden" name="nonce" value='. wp_create_nonce("mobsms-account-nonce").' >
       </form>';
?>
    <script>
        ...
        jQuery('a[href=\"#mo2f_account_exist\"]').click(function (e) {
            jQuery('.mobsms_verify_customerform').submit();
        });
