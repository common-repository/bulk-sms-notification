<!-- The Modal -->
    <div id="wpns_feedback_modal" class="mo_modal" style="width:90%; margin-left:12%; margin-top:5%; text-align:center; margin-left;">
        ...
        <div class="mo_wpns_modal-content" style="width:50%;">
            ...
            <form name="f" method="post" action="" id="mobsms_feedback">
                <?php wp_nonce_field("mobsms_feedback");?>
                <input type="hidden" name="option" value="mobsms_feedback"/>
                    ...
                    <input type="radio" name="rate" id="angry" value="1"/>
                        <label for="angry"><img class="sm" src="<?php echo esc_html($imagepath) . 'angry.png'; ?>" />
                        </label>
                        
                    <input type="radio" name="rate" id="sad" value="2"/>
                        <label for="sad"><img class="sm" src="<?php echo esc_html($imagepath) . 'sad.png'; ?>" />
                        </label>
                    
                    
                    <input type="radio" name="rate" id="neutral" value="3"/>
                        <label for="neutral"><img class="sm" src="<?php echo esc_html($imagepath). 'normal1.png'; ?>" />
                        </label>
                        
                    <input type="radio" name="rate" id="smile" value="4"/>
                        <label for="smile">
                        <img class="sm" src="<?php echo esc_html($imagepath) . 'smile.png'; ?>" />
                        </label>
                        
                    <input type="radio" name="rate" id="happy" value="5" checked/>
                        <label for="happy"><img class="sm" src="<?php echo esc_html($imagepath) . 'happy.png'; ?>" />
                        </label>
                    ...
                    <div style="text-align:center;">
                        ...
                        <label for="edit"><img class="editable" src="<?php echo esc_html($imagepath) . '61456.png'; ?>" />
                        </label>
                        
                        </div>
                        <br><br>
                        <textarea id="mobsms_query_feedback" name="mobsms_query_feedback" rows="4" style="width: 60%"
                    ...
                    <div class="mo-modal-footer" style="text-align: center;margin-bottom: 2%">
                        <input type="submit" name="mobsms_feedback_submit"
                               style="background-color:#20b2aa; padding: 1% 3% 1% 3%;color: white;cursor: pointer;" value="Send"/>
                        <span width="30%">&nbsp;&nbsp;</span>
                        <input type="button" name="miniorange_skip_feedback"
                               style="background-color:#20b2aa; padding: 1% 3% 1% 3%;color: white;cursor: pointer;" value="Skip" onclick="document.getElementById('mobsms_feedback_form_close').submit();"/>
                    </div>
                </div>
            ...
            <form name="f" method="post" action="" id="mobsms_feedback_form_close">
                <?php wp_nonce_field("mobsms_skip_feedback");?>
                <input type="hidden" name="option" value="mobsms_skip_feedback"/>
            </form>
    ...
    <script>
        jQuery('#deactivate-bulk-sms-notification').click(function () {
...
// When the user clicks the button, open the mo2f_modal
            ...
            document.querySelector("#mobsms_query_feedback").focus();
